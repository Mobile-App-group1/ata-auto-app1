...
gettextstyltital(BuildContext context) {
  return TextStyle(
      fontSize: ResponsiveValue(context,
              conditionalValues: [
                Condition.equals(name: MOBILE, value: 18.0),
...
gettextstylblackdesription(BuildContext context) {
  return TextStyle(
    fontSize: ResponsiveValue(context,
            conditionalValues: [
...
gettextstylblack(BuildContext context) {
  return TextStyle(
    fontSize: ResponsiveValue(context,
            conditionalValues: [
              Condition.equals(name: MOBILE, value: 14.0),
...
gettextstylblackname(BuildContext context) {
  return TextStyle(
    fontSize: ResponsiveValue(context,
            conditionalValues: [
              Condition.equals(name: MOBILE, value: 14.0),
...
gettextstylgreytital(BuildContext context) {
  return TextStyle(
    fontSize: ResponsiveValue(context,
            conditionalValues: [
              Condition.equals(name: MOBILE, value: 12.0),
...
gettextstylgreytexproduct(BuildContext context) {
  return TextStyle(
      fontSize: ResponsiveValue(context,
              conditionalValues: [
                Condition.equals(name: MOBILE, value: 16.0),
...
final colorBlue = Colors.blue[400];
final bggrey = Colors.grey[50];
final textgrey = Colors.grey[200];
